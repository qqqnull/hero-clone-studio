...
export function WhyNeedSection() {
  ...
  return (
    <section className="py-20 bg-[#2d3a5f]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-6 max-w-5xl mx-auto">
          {reasons.map((reason, index) => (
            <div key={index} className="flex items-start gap-4">
              ...
              <span className="text-white text-base leading-relaxed">{reason}</span>
            </div>
          ))}
        </div>

        <p className="text-center text-white/70 mt-10 max-w-3xl mx-auto">
